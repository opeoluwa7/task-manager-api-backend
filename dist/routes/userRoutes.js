...
router.get('/find-user', isAuthorized_1.default.check, findUserController_1.default);
router.patch('/update-user', isAuthorized_1.default.check, updateUserController_1.default);
router.delete('/delete-user', isAuthorized_1.default.check, deleteUserController_1.default);
