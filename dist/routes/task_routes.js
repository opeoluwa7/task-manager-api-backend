...
router.get('/all-tasks', [is_authorized_1.default.check, rateLimit, uploadMiddleware_1.default.single("image")], task_controller_1.default.getAllTasks);
router.post('/create-task', [is_authorized_1.default.check, rateLimit], task_controller_1.default.createNewTask);
